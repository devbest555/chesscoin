...
isEmpty(BOOST_THREAD_LIB_SUFFIX) {
    windows:BOOST_THREAD_LIB_SUFFIX=-mgw48-mt-s-1_57
    else:BOOST_THREAD_LIB_SUFFIX=$$BOOST_LIB_SUFFIX
}

isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /opt/local/lib/db48
    windows:BDB_LIB_PATH=$$PWD/3party/db-4.8.30.NC/build_windows
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH=$$PWD/3party/db-4.8.30.NC/build_windows
}
...
isEmpty(OPENSSL_INCLUDE_PATH){
    windows:OPENSSL_INCLUDE_PATH=$$PWD/3party/openssl-1.0.1l/include
}
isEmpty(OPENSSL_LIB_PATH){
    windows:OPENSSL_LIB_PATH=$$PWD/3party/openssl-1.0.1l
}
...
LIBS += -lssl -lcrypto -ldb-4.8 -ldb_cxx-4.8
